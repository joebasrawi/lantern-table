...
| Customizable characters | Species/concept/stat assignment, editable roles and attributes, identity edits, custom portraits, progression and host-reviewed named ability templates; ownership and persistence tests | Custom ability effects are currently Strike and Mend. Arbitrary rules scripting remains unfinished. Generated portrait preview/save/reload passed with one real provider request; broader art-quality playtesting remains. |
