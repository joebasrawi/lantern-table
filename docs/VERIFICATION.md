...
| Customizable characters | Species/concept/stat assignment, editable roles and attributes, identity edits, custom portraits, progression and host-reviewed named ability templates; ownership and persistence tests | Custom ability effects are currently Strike and Mend. Arbitrary rules scripting and AI portrait generation are unfinished. |
